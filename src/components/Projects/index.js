          ...
          <Row className="projectRow">
            <Collapsible label="Weather App">
              ...
              <p id="projectTwo">
                ...
                will make an API call to retrieve, then append live data onto
                the home page. The data consists of: tempurature, wind speed,
                humidity, and UV index for the current and five day forecast.
                Once a search has been made the application saves the city in
                local strorage. Doing this allows the user to generate another
                API call to get live results of the weather.
              </p>
            </Collapsible>
          </Row>
        </Link>
          ...
          <Row className="projectRow">
            <Collapsible label="Professional README Generator">
              ...
              <p id="projectThree">
                ...
                README.md for current or future projects. Answer the questions
                and give a brief description of the topics after the application
                has been installed and started in the integrated terminal. When
                the questions are finished the application will generate and
                store a README.md inside the Develop folder.
              </p>
            </Collapsible>
          </Row>
        </Link>
          ...
          <Row className="projectRow">
            <Collapsible label="Workday Planner">
              ...
              <p id="projectFour">
                ...
                hours in a workday. Inside the time blocks, add a task and
                select the blue save button. The application will then save the
                task to local storage for future reference.
              </p>
            </Collapsible>
          </Row>
        </Link>
          ...
          <Row className="projectRow">
            <Collapsible label="codeQuiz">
              ...
              <p id="projectFive">
                ...
                increasing the pressure on the player. When the timer runs out
                the game is over and the score that you ended with will display
                on the screen. A "Save initals" and "Input Field" will display.
                Save your initials, reset and play again!
              </p>
            </Collapsible>
          </Row>
        </Link>
